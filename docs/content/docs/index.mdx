...
<Callout type="warn" title="Provider-type caveats">
Some endpoints only work against a matching upstream provider family. Selecting the wrong provider type returns `501 Not Implemented`.
</Callout>
